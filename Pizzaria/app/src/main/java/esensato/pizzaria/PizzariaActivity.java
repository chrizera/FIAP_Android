...
implements AdapterView.OnItemSelectedListener,
    ...
    private void calcularPreco() {
        double preco = selecionada.getPreco();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        selecionada = (PizzaBean) parent.getItemAtPosition(position);
        Toast.makeText(this, selecionada.getSabor(), Toast.LENGTH_SHORT).show();
        // troca a imagem da pizza (ImageView) de acordo
        // com o R.drawable definido no PizzaBean
        imgPizza.setImageResource(selecionada.getImagem());
